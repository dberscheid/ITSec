...
<<<<<<< HEAD
\lstinputlisting[language=Python, caption={timer.py}, label={lst:timer}, captionpos=b,  xleftmargin=.02\textwidth, linewidth = 0.95\columnwidth]{CodeFiles/CoriaETL/timer.py}
=======
\vspace{0.3cm}
...
>>>>>>> 20a333385c2119146cac5b6f2e164b1f73a1d465
